...
<p style="text-align: center;"><strong>LekolPress</strong> est une plateforme web hébergée et gérée qui permet aux écoles et aux universités d'avoir une présence en ligne, de gérer leurs systèmes d’information scolaire et d'interagir facilement avec élèves, professeurs et parents.</p>
...
[/vc_column_text][kleo_button title="Voir Une Demonstration" href="https://lekolpress.com/demo/school-login/" position="center" size="lg" icon="0"][/vc_column_inner][/vc_row_inner][kleo_gap size="80px"][/vc_column][/vc_row][vc_row inner_container="no" section_type="socket" vertical_align="yes" padding_top="0" padding_bottom="0"][vc_column width="1/2" css=".vc_custom_1571180661214{padding-left: 10px !important;}"][vc_row_inner css=".vc_custom_1571181059739{margin-left: 10px !important;}"][vc_column_inner css=".vc_custom_1571180942921{padding-left: 10px !important;}"][kleo_gap size="80px"][vc_column_text]
